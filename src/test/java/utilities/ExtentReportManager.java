...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		sparkReporter.config().setReportName("Be.cognizant Header view Testing"); // name of the report
		sparkReporter.config().setTheme(Theme.DARK);
		
		extent = new ExtentReports();
		extent.attachReporter(sparkReporter);
		extent.setSystemInfo("Application", "Be.cognizant_Page");
		extent.setSystemInfo("Module", "Header");
		extent.setSystemInfo("Sub Module", "List_of_header");
		extent.setSystemInfo("User Name", "Subhash_B");
